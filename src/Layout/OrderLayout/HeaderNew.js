        ...
        <nav className="navbar navbar-expand-lg navbar-light sticky-top px-0">
            <div className="container-fluid">
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <div className="navbar-nav ml-auto pe-4 py-3 py-lg-0 align-items-center">
                  ...
                  <div className='input__SearchHeader'>
                    <input type="text" className='form-control search_InpUt' placeholder='Search here' />
                    <i class="fa fa-search search_IcOns" aria-hidden="true"></i>
                  </div>
                </div>
