...
export default function Fiction() {
  const loop =[
    ...
    const Slider = () => {
        window.$('#top__Books_fiction').not(".slick-initialized").slick({
            slidesToShow: 1,
            slidesToScroll: 1,
            dots: false,
            arrows: true,
   ...
   <>
    <div className="top__SelfHelpBook">
          <div className="d-flex align-items-center justify-content-between">
            <h4 className="section_Title">Top books in Fiction</h4>
            <p>
              See all{" "}
              <span>
                <img
          ...
          <div className="slick-slider" id="top__Books_fiction">
